...
const CompetencyWorkbook = () => {
  ...
  const downloadFinalText = () => {
    ...
    const bodyContent = finalText && finalText.trim()
      ...
      : `<p style="font-size:11pt;line-height:2.0;color:#6E7A8F;margin:0 0 14pt 0;font-style:italic;">[직무역량 본문이 여기에 들어갑니다.]</p>`;
...
<p style="font-size:22pt;font-weight:bold;color:#0E2750;text-align:center;margin:0 0 6pt 0;padding-bottom:14pt;border-bottom:3pt solid #0E2750;letter-spacing:8pt;">직 무 역 량</p>
${metaLine}
...
${notesSection}
    ...
    a.download = `직무역량_${(basicInfo.company || '미입력').replace(/[^a-zA-Z0-9가-힣\s]/g, '_')}_${today}.doc`;
...
<div class="Section1">
<p style="text-align:right;color:#6E7A8F;font-size:10pt;margin:0 0 4pt 0;">작성일 · ${today}</p>
<p style="font-size:22pt;font-weight:bold;color:#0E2750;text-align:center;margin:0 0 6pt 0;padding-bottom:14pt;border-bottom:3pt solid #0E2750;letter-spacing:6pt;">직무역량 작성 노트</p>
${metaLine}
...
<div style="font-size:11pt;line-height:1.8;color:#0E2750;white-space:pre-wrap;mso-pre-wrap:yes;">${rawHtml}</div>
    ...
    const u = URL.createObjectURL(b);
    const a = document.createElement('a'); a.href = u;
    a.download = `직무역량_작성노트_${(basicInfo.company || '미입력').replace(/[^a-zA-Z0-9가-힣\s]/g, '_')}_${today}.doc`;
    document.body.appendChild(a); a.click(); document.body.removeChild(a);
    setTimeout(() => URL.revokeObjectURL(u), 1000);
